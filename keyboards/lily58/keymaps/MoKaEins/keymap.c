...
[_BASE] =  LAYOUT(
      ...
      MO(_GAMING), KC_Z, KC_X, KC_C, KC_V, KC_B, MO(_NUM),    MO(_FKEYS), KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(_UMLAUT),
      KC_LGUI, KC_LALT, KC_LCTL, LT(_UMLAUT, KC_SPC),                     KC_SPC, KC_BSPC, KC_DEL, MO(_ARROW)
),
[_FKEYS] = LAYOUT(
...
[_GAMING] = LAYOUT(
      ...
      KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G,               KC_H, KC_J, KC_K, KC_L, KC_SCLN, TO(_BASE),
      KC_LCTL, KC_Y, KC_X, KC_C, KC_V, KC_B, KC_NO,      KC_N, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
[_UMLAUT] = LAYOUT(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_NUBS, LSFT(KC_NUBS), KC_VOLD, KC_TRNS,
