...
[_BASE] =  LAYOUT(
      ...
      TO(_GAMING), KC_Z, KC_X, KC_C, KC_V, KC_B, MO(_NUM),    MO(_NUM), KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(_UMLAUT),
...
[_NUM] = LAYOUT(
      ...
      KC_CAPS, KC_F11, KC_F12, KC_TRNS, KC_TRNS, KC_TRNS,                        KC_NO, KC_P1, KC_P2, KC_P3, KC_PEQL, KC_HOME,
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS, KC_NO, KC_P0, KC_PDOT, KC_PCMM, KC_PMNS, KC_END,
      KC_RGUI, KC_RALT, KC_RCTL, KC_TRNS,                                     KC_TRNS, KC_DEL, KC_TRNS, KC_TRNS
  ),
...
[_UMLAUT] = LAYOUT(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_NUBS, LSFT(KC_NUBS), KC_VOLD, KC_BRID,
