...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_WINDOWS] =  LAYOUT(
      ...
      MO(_UMLAUT), KC_Z, KC_X, KC_C, KC_V, KC_B, MO(_NUM),      MO(_FKEYS), KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RCTL,
...
[_MAC] = LAYOUT(
      ...
      KC_LSFT, KC_A, KC_R, KC_S, KC_T, KC_D,                       KC_H, KC_N, KC_E, KC_I, KC_O, KC_RSFT,
      MO(_UMLAUT),KC_Z,KC_X,KC_C,KC_V, KC_B, MO(_NUM), MO(_FKEYS), KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RCTL,
      KC_LCTL,      KC_LALT,      KC_LGUI,      KC_SPC,      KC_SPC,      KC_BSPC,      KC_ENT,      MO(_ARROW)
  ),

[_FKEYS] = LAYOUT(
      KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                     KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
      KC_TRNS, KC_TRNS, DF(_WINDOWS), KC_TRNS, KC_PSCR, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLU, KC_F12,
      KC_NO, KC_QUOT, KC_TRNS, KC_MINS, KC_TRNS, KC_TRNS,            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,
      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,      KC_TRNS, KC_NO, DF(_MAC), KC_INS, KC_HOME, KC_VOLD, KC_END,
...
[_UMLAUT] = LAYOUT(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS, KC_LBRC, KC_TRNS, KC_BRIU, KC_TRNS,
      KC_TRNS, KC_QUOT, KC_TRNS, KC_MINS, KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS, KC_EQL, RALT(KC_NUBS), KC_SCLN, KC_TRNS,
      KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,  KC_NO, KC_TRNS, KC_TRNS, KC_NUBS, LSFT(KC_NUBS), KC_BRID, KC_NO,
      KC_NO,      KC_RALT,      KC_RCTL,      KC_NO,      KC_NO,      KC_DEL,      KC_NO,      KC_NO
  )
};
